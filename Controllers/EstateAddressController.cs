...
namespace DiplomenProekt.Controllers
{
    ...
    public class EstateAddressController : Controller
    {
        ...
        public EstateAddressController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,City,Neighbourhood,Pics,Description,IsDeleted")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,City,Neighbourhood,Pics,Description,IsDeleted")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
