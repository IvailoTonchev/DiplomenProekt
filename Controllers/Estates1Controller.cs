...
{
    public class Estates1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Estates1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MainPic,Price,Rooms,AddressId,Description,Pictures,EstateType,EstateStatus,Area,Floor,MaxFloor,ExtrasId,IsDeleted")] Estate estate)
        {
